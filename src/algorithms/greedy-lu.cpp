...
bool GreedyLU(std::string file, std::vector<std::vector<int>> &neighbors, int size)
{
    std::cout << std::endl;
...
/*
    ...
    output << file << ", " << size << ", " << "Greedy-LU" << ", " << "1" << ", " << color_dur.count() << ", " << max_colors << ", " << valid_str << std::endl;
